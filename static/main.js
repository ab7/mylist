...
$(function () {
  ...
  function validate() {
    $('.submitBox').keypress(function (event) {
      var item, part1, part2, part3, wholeItem;
      if (event.which === 13) {
        item = $(this).val();
        if (item) {
          if (item.trim() === "") {
            ...
            part1 = '<div class="item"><input class="checkBox floatL" type="checkbox">';
            part2 = '<span class="itemContent floatL">';
            part3 = '</span><button class="delete floatR">X</button></div>';
            wholeItem = part1 + part2 + item + part3;
